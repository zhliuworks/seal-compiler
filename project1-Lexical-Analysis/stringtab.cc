...
template class StringTable<FloatEntry>;
...
// as nodes of the abstract syntax tree defined by the seal-tree.aps.
...
FloatEntry::FloatEntry(char *s, int l, int i) : Entry(s,l,i) { }
